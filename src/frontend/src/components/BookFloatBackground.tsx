...
// ── Book cover images (Unsplash, CORS-enabled) ────────────────────────────────
const IMAGE_URLS = [
...
// ── Component ─────────────────────────────────────────────────────────────────
interface Props {
  /** When false, fades the canvas out (CSS). Animation loop keeps running. */
  visible?: boolean;
}

export function BookFloatBackground({ visible = true }: Props) {
  ...
  }, []); // run once on mount; animation is always live, CSS controls visibility
