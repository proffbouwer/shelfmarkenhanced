        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {(isDropdownOpen || isClosing) && (
            ...
            >
              <div className="py-1">
                <a
                  href="https://github.com/proffbouwer/shelfmarkenhanced/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {isAdmin && <UsersButton closeDropdown={closeDropdown} />}
...
// ---------------------------------------------------------------------------
// UsersButton — standalone component so it can call useNavigate
// ---------------------------------------------------------------------------
function UsersButton({ closeDropdown }: { closeDropdown: () => void }) {
